...
class WidgetLogoApp extends StatefulWidget {
  @override
  _WidgetLogoAppState createState() => new _WidgetLogoAppState();
}

class _WidgetLogoAppState extends State<WidgetLogoApp> with SingleTickerProviderStateMixin{
